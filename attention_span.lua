...
-- dimensions
ATTENTION_SPAN_X = 12
ATTENTION_SPAN_SHOWN_Y = 116
ATTENTION_SPAN_HIDDEN_Y = 129
...
function _attention_span_draw(self)
    ...
    rectfill(self.x -1, self.y -1, self.x + ATTENTION_SPAN_BOX_WIDTH + 1, self.y + ATTENTION_SPAN_BOX_HEIGHT + 1, ATTENTION_SPAN_TEXT_COLOR)
    rectfill(self.x -2, self.y, self.x + ATTENTION_SPAN_BOX_WIDTH + 2, self.y + ATTENTION_SPAN_BOX_HEIGHT, ATTENTION_SPAN_TEXT_COLOR)
